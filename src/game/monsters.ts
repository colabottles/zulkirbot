...
export const MONSTERS: Record<number, Monster[]> = {
  ...
  1: [
    ...
    { name: 'Skeleton', hp: 4, attack: 1, defense: 2, xp_reward: 20, gold_reward: 2, loot_chance: 10, is_undead: true, undead_specials: ['paralysis'], special_chance: 25 },
    ...
    { name: 'Zombie', hp: 5, attack: 2, defense: 1, xp_reward: 20, gold_reward: 2, loot_chance: 8, is_undead: true, undead_specials: ['disease'], special_chance: 30 },
  ],
  // Levels 6-10: Medium
  2: [
    ...
    { name: 'Shadow', hp: 8, attack: 3, defense: 2, xp_reward: 45, gold_reward: 3, loot_chance: 15, is_undead: true, undead_specials: ['level_drain'], special_chance: 25 },
    { name: 'Hobgoblin', hp: 11, attack: 3, defense: 2, xp_reward: 40, gold_reward: 5, loot_chance: 10 },
    { name: 'Ghoul', hp: 10, attack: 3, defense: 2, xp_reward: 45, gold_reward: 4, loot_chance: 12, is_undead: true, undead_specials: ['paralysis'], special_chance: 30 },
    ...
    { name: 'Specter', hp: 8, attack: 4, defense: 2, xp_reward: 50, gold_reward: 3, loot_chance: 15, is_undead: true, undead_specials: ['level_drain'], special_chance: 30 },
  ...
  3: [
    ...
    { name: 'Vampire Spawn', hp: 20, attack: 6, defense: 4, xp_reward: 100, gold_reward: 12, loot_chance: 18, is_undead: true, undead_specials: ['level_drain', 'gold_drain'], special_chance: 35 },
  ],
  // Levels 21-30: Difficult
  4: [
    { name: 'Stone Giant', hp: 35, attack: 7, defense: 5, xp_reward: 150, gold_reward: 20, loot_chance: 18 },
    { name: 'Banshee', hp: 28, attack: 8, defense: 4, xp_reward: 160, gold_reward: 12, loot_chance: 22, is_undead: true, undead_specials: ['fear'], special_chance: 40 },
    ...
    { name: 'Revenant', hp: 35, attack: 8, defense: 5, xp_reward: 165, gold_reward: 15, loot_chance: 18, is_undead: true, undead_specials: ['disease'], special_chance: 30 },
  ...
  5: [
    ...
    { name: 'Vampire', hp: 45, attack: 11, defense: 7, xp_reward: 260, gold_reward: 40, loot_chance: 28, is_undead: true, undead_specials: ['level_drain', 'gold_drain'], special_chance: 40 },
    ...
    { name: 'Lich', hp: 55, attack: 13, defense: 8, xp_reward: 340, gold_reward: 55, loot_chance: 35, is_undead: true, undead_specials: ['level_drain', 'paralysis'], special_chance: 40 },
    { name: 'Death Knight', hp: 52, attack: 12, defense: 8, xp_reward: 320, gold_reward: 50, loot_chance: 30, is_undead: true, undead_specials: ['fear', 'disease', 'necrotic_fire'], special_chance: 35 },
