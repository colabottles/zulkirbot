...
client.connect().then(async () => {
  ...
  client.say(`#${process.env.TWITCH_CHANNEL}`, `🎲 ZulkirBot v2.0.1 is online! Check the docs for the latest changes and new commands: https://zulkirbot-docs.netlify.app`)
