...
const RUMOURS: string[] = [
  ...
  `🗣️ "There's a merchant named Crom who pays good coin for cursed items. Don't ask me where he sells them."`,
  ...
  `🗣️ "They say if you whisper Grabthar's name into the shrine at midnight, something answers."`,
